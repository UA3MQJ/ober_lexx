...
int_validate(Chars, Line) ->
  TChars = int_validate_del_zero(Chars).
...
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 71, C =< 90 ->
...
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 38 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 40 ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
...
yystate(0, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 70 ->
    yystate(0, Ics, Line, Tlen+1, 1, Tlen);
yystate(0, [C|Ics], Line, Tlen, _, _) when C >= 73, C =< 90 ->
    yystate(3, Ics, Line, Tlen+1, 1, Tlen);
...
-file("./obr.xrl", 20).
yyaction_1(TokenChars, TokenLine) ->
     { token, { id, TokenLine, id_validate (TokenChars, TokenLine) } } .

-compile({inline,yyaction_2/2}).
-file("./obr.xrl", 21).
yyaction_2(TokenChars, TokenLine) ->
     { token, { int, TokenLine, int_validate (TokenChars, TokenLine) } } .

-compile({inline,yyaction_3/2}).
-file("./obr.xrl", 22).
yyaction_3(TokenChars, TokenLine) ->
     { token, { int, TokenLine, intwr_validate (TokenChars, TokenLine) } } .

-compile({inline,yyaction_4/2}).
-file("./obr.xrl", 23).
yyaction_4(TokenChars, TokenLine) ->
     { token, { str, TokenLine, str_validate (TokenChars, TokenLine) } } .
