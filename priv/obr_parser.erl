...
-compile({nowarn_unused_function,  yeccgoto_deselem1/7}).
...
-compile({nowarn_unused_function,  yeccgoto_deselem2/7}).
...
-compile({nowarn_unused_function,  yeccgoto_deselem3/7}).
...
-compile({nowarn_unused_function,  yeccgoto_deselem4/7}).
...
-compile({nowarn_unused_function,  yeccgoto_deslist2/7}).
...
-compile({nowarn_unused_function,  yeccgoto_t_array_list/7}).
...
yeccpars2_266_(__Stack0) ->
 [___3,___2,___1 | __Stack] = __Stack0,
 [begin
                                            {t_array_list, str_of(___1), value_of(___1) + 1}
  end | __Stack].
