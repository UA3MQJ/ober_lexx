...
yystate(14, [C|Ics], Line, Tlen, Action, Alen) when C >= 71, C =< 90 ->
...
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 33 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 93 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
...
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 38 ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 40, C =< 93 ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 95, C =< 123 ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 125 ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
...
yystate(2, Ics, Line, Tlen, _, _) ->
    {0,Tlen,Ics,Line,2};
yystate(1, [88|Ics], Line, Tlen, _, _) ->
    yystate(5, Ics, Line, Tlen+1, 1, Tlen);
yystate(1, [72|Ics], Line, Tlen, _, _) ->
