...
yystate(24, [10|Ics], Line, Tlen, _, _) ->
    yystate(24, Ics, Line+1, Tlen+1, 11, Tlen);
...
yystate(22, [C|Ics], Line, Tlen, Action, Alen) when C >= 71, C =< 90 ->
...
yystate(20, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 33 ->
    yystate(20, Ics, Line, Tlen+1, Action, Alen);
yystate(20, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 93 ->
    yystate(20, Ics, Line, Tlen+1, Action, Alen);
...
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 38 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 40, C =< 93 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
...
yystate(11, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(11, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 41 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
...
yystate(10, Ics, Line, Tlen, _, _) ->
    {0,Tlen,Ics,Line,10};
yystate(9, [88|Ics], Line, Tlen, _, _) ->
...
yystate(8, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(8, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 41 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(8, [C|Ics], Line, Tlen, Action, Alen) when C >= 43 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
...
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 41 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 43 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(7, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,7};
yystate(6, [89|Ics], Line, Tlen, _, _) ->
    yystate(10, Ics, Line, Tlen+1, 0, Tlen);
yystate(6, [90|Ics], Line, Tlen, _, _) ->
    yystate(10, Ics, Line, Tlen+1, 0, Tlen);
yystate(6, [88|Ics], Line, Tlen, _, _) ->
    yystate(10, Ics, Line, Tlen+1, 0, Tlen);
yystate(6, [72|Ics], Line, Tlen, _, _) ->
    yystate(10, Ics, Line, Tlen+1, 0, Tlen);
yystate(6, [71|Ics], Line, Tlen, _, _) ->
    yystate(10, Ics, Line, Tlen+1, 0, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(6, Ics, Line, Tlen+1, 0, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 70 ->
    yystate(6, Ics, Line, Tlen+1, 0, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 73, C =< 87 ->
    yystate(10, Ics, Line, Tlen+1, 0, Tlen);
...
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 40 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(4, [C|Ics], Line, Tlen, Action, Alen) when C >= 43 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
...
yystate(3, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(3, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 40 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(3, [C|Ics], Line, Tlen, Action, Alen) when C >= 43 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
...
yystate(0, [10|Ics], Line, Tlen, _, _) ->
    yystate(8, Ics, Line+1, Tlen+1, 10, Tlen);
yystate(0, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(8, Ics, Line, Tlen+1, 10, Tlen);
yystate(0, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 41 ->
    yystate(8, Ics, Line, Tlen+1, 10, Tlen);
yystate(0, [C|Ics], Line, Tlen, _, _) when C >= 43 ->
    yystate(8, Ics, Line, Tlen+1, 10, Tlen);
